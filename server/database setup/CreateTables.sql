...
(
  ...
  SkillRating INT NOT NULL DEFAULT 0
);
...
(
  ...
  HostSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES Account(AccountSK),
...
(
  ...
  AccountSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES Account(AccountSK),
  GameSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES Game(GameSK),
...
(
  ...
  GameSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES Game(GameSK),
  WinnerSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES GameMember(GameMemberSK),
  LoserSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES GameMember(GameMemberSK)
);
...
(
  ...
  GameSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES Game(GameSK),
  PlayerSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES GameMember(GameMemberSK)
);
...
(
  CardSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES Card(CardSK),
  DeckSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES Deck(DeckSK),
  DeckCardOrder TINYINT CONSTRAINT CK_DeckCards_Order CHECK (DeckCardOrder > 0 AND DeckCardOrder < 61)
);

CREATE TABLE DiscardPileCard
(
  CardSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES Card(CardSK),
  DiscardPileSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES DiscardPile(DiscardPileSK)
);

CREATE TABLE HandCard
(
  CardSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES Card(CardSK),
  HandSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES Hand(HandSK)
);

CREATE TABLE ScorePileCard
(
  CardSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES Card(CardSK),
  ScorePileSK UNIQUEIDENTIFIER FOREIGN KEY REFERENCES ScorePile(ScorePileSK)
);

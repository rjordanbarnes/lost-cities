...
VALUES ('Jordan', (SELECT RoomID FROM Rooms WHERE RoomName='The Newest Room'), 1, 0),
       ('Keysi', (SELECT RoomID FROM Rooms WHERE RoomName='The Newest Room'), 1, 1),
       ('Joshua', (SELECT RoomID FROM Rooms WHERE RoomName='The Oldest'), 1, 1),
       ('Timmy', (SELECT RoomID FROM Rooms WHERE RoomName='Middle Room'), 1, 1),
       ('Rini', NULL, 0, 0),
       ('Salem', NULL, 0, 0)
